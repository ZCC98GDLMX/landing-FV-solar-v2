...
const servicios = [
  {
    ...
    bullets: ["Levantamiento y diseño", "Instalación profesional y conforme a normativa vigente", "Monitoreo, garantía en módulos, inversor y mano de obra"],
  },
  {
      ...
      <section className="mx-auto max-w-6xl px-4 py-16">
        <div className="rounded-2xl bg-yellow-500 text-white p-8 md:p-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <div className="flex gap-3">
            ...
            <a href={whatsappLink("Hola, quiero agendar un diagnóstico sin costo.")} className="rounded-xl px-5 py-3 bg-yellow-700 text-white font-semibold shadow hover:bg-emerald-800">WhatsApp</a>
          </div>
        </div>
      </section>
